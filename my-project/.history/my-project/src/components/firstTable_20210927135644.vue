<template>
  ...
  >
    ...
    >
      ...
      <!-- 表头右侧两个模块 -->
      <div style="display: flex; justify-content: space-around; width: 11vw">
        <div>
          <img
            src="../assets/e.png"
            style="height: 2.5vh; margin-top: 1.5vh; margin-left: 2vw"
          />
        </div>
        <div>
          <div
        ...
        <div>
          <img
            :src="photoURL"
            style="width: 2.5vw; height: 5vh; border-radius: 25px;margin-top:0.5vh"
          />
        </div>
      </div>
      <!-- 表头右侧两个模块 -->
