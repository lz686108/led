<template>
  <div style="background-color: #091022; width: 100vw; height: 100vh">
    ...
    <div>
      <!-- 表格部分第一行 -->
      <div style="display: flex; justify-content: flex-start;height:4vh;line-height:4vh">
        <img src="../assets/gbgl_icon1.png" style="height: 2vh;margin-top:1vh;margin-left:0.5vw" />
        <span style="color: white"> 打结 </span>
      </div>
      <div style="margin-left: 0.5vw">
        <!-- 表格背景色 -->
        <div style="height: 42.5vh; width: 41vw; background-color: #2a354b">
          <table class="table" style="border-collapse: collapse">
            <thead style="color: #f8faff; margin-top: 1vh; width: 40vw">
              <tr>
                <th>序号</th>
                <th>日期</th>
                <th>包号</th>
