  ...
  <div style="background-color: #091022; width: 100vw; height: 100vh">
    ...
    >
      ...
      <div
        ...
        "
      >
        <span style="color: #bfe5f8; margin-left: -1.5vw;font-size:0.5vw;">班别</span>
        <select
          style="
            height: 3.3vh;
            margin-left: 0.6vw;
...
export default {
  ...
  created() {
    ...
    axios({
      method: "post",
      url: "http://localhost:40001/mpd/led/ladleonlinestate/selectShift",
      params: {},
    }).then((res) => {
    ...
    axios({
      method: "post",
      url: "http://localhost:40001/mpd/led/ladleonlinestate/selectSecond",
      params: {},
    }).then((res) => {
  ...
  methods: {
    ...
    selectByLadleNo() {
      axios({
        method: "post",
        url: "http://localhost:40001/mpd/led/ladleonlinestate/selectFirstByLadleNo",
        params: {
