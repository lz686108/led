  ...
  <div style="background-color: #091022; width: 100vw; height: 100vh">
    ...
    >
      ...
      <table class="table">
            ...
            <tbody style="color: #bde5f7">
              <tr v-for="(item, index) in measure" :key="index">
                <td style="text-align: left">{{ item.companyname }}</td>
                <td style="text-align: left">{{ item.samplename }}</td>
                <td style="text-align: left">{{ item.element }}</td>
                <td v-if="item.standard2 == ''" style="text-align: left">
                  {{ item.symbol }}
                  {{ item.standard1 }}
                  {{ item.standard2 }}
                </td>
                ...
                <td style="text-align: left">{{ item.functionary }}</td>
                <td>
                  <img
                    src="../assets/update.png"
                    @click="update(item)"
                    style="cursor: pointer; width: 1.2vw"
                  />
                </td>
                <td>
                  <img
                    src="../assets/delete.png"
                    @click="deleteMeasureById(item.id, item.samplename)"
                    style="cursor: pointer; width: 1.2vw"
                  />
                </td>
              </tr>
