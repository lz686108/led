  ...
  <div style="background-color: #091022; width: 100vw; height: 100vh">
    ...
    <!-- 表头部分 -->
      <table class="table-list">
            <thead style="height: 30px; line-height: 28px">
              <tr>
                <td style="width: 5.2vw; text-align: center">区域</td>
                <td style="width: 7vw">价格项目</td>
                <td style="width: 4vw; text-align: right">平均值</td>
              </tr>
            </thead>
            <tbody
              ref="systemForm"
            ...
            >
              ...
              >
                <td
                  :rowspan="item.num"
                  v-if="item.static"
                  style="width: 5.2vw; text-align: center"
                >
                  {{ item.name }}
                </td>
                <td style="width: 7vw; height: 23.5px">{{ item.pic }}</td>
                <td style="width: 4vw; height: 23.5px; text-align: right">
                  {{ parseInt(datalist.avg[index]) }}
                </td>
              </tr>
            </tbody>
          </table>
