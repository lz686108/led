            ...
            >
              ...
              >
                <tr v-for="(item, index) in bakeStartList" :key="index">
                  ...
                  <td style="text-align:right">{{ item.offlineresponsername }}</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export default {
  ...
  methods: {
    ...
    selectLadleState() {
      axios({
        method: "post",
        url: "http://localhost:40002/mpd/led/ladleonlinestate/selectLadleState",
        params: {
    ...
    nextDate() {
      ...
      if(a2-a1<=24 * 60 * 60 * 1000){
        if((a2 + 24 * 60 * 60 * 1000)<(new Date().getTime())){
          this.value1 = this.convertToDate(new Date(this.value1[0]).getTime() + 24 * 60 * 60 * 1000); //格式化日期并赋值
          this.value2 = this.convertToDate(new Date(this.value1[1]).getTime() + 24 * 60 * 60 * 1000); //格式化日期并赋值
        }
      }
    },
    //前一天
    prevDate() {
      ...
      let a2=new Date(this.value2).getTime()
      if(a2-a1<=24 * 60 * 60 * 1000){
        this.value1 = this.convertToDate(new Date(this.value1).getTime() - 24 * 60 * 60 * 1000); //格式化日期并赋值
        this.value2 = this.convertToDate(new Date(this.value2).getTime() - 24 * 60 * 60 * 1000); //格式化日期并赋值
        // this.value1=row;
      }
    },
    convertToDate(date) {
