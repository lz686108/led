    ...
    >
      ...
      >
        ...
        <select
          ...
          "
        >
          <option v-for="(item,index) in selectShift" :key="index" :v-model="shift">{{item}}</option>
        </select>
      </div>
      <!-- 班别 -->
      <div
      ...
      >
        ...
        <select
          ...
          "
        >
          <option v-for="(item,index) in selectSecond" :key="index" :v-model="second">{{item}}</option>
        </select>
      </div>
      <!-- 包号输入按钮 -->
      <div
