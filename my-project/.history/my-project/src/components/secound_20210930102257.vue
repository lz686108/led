    ...
    >
      ...
      <div style="width: 8vw; margin-left: 1.5vw; margin-top: 1vh">
        <div
          ...
          "
        >
          <div @click="turnFirst()" style="width: 2.5vw; font-size: 0.8vw">
            热修
          </div>
          <div
            style="
...
export default {
  ...
  methods: {
    ...
    displayToday() {
      ...
      this.value1[0] = year + seperator1 + month + seperator1 + strDate;
      this.value1[1] = year + seperator1 + month + seperator1 + strDate;
    },
    nextDate() {
      //后一天
      let odata = new Date(
      ...
      this.value1[0] = this.convertToDate(odata); //格式化日期并赋值
      this.value1[1] = this.convertToDate(odata); //格式化日期并赋值
    },
    prevDate() {
      ...
      //前一天
       //计算当前日期 -1
      console.log(odata);
      this.value1[0] = this.convertToDate(new Date(this.value1[0]).getTime() - 24 * 60 * 60 * 1000); //格式化日期并赋值
      this.value1[1] = this.convertToDate(new Date(this.value1[1]).getTime() - 24 * 60 * 60 * 1000); //格式化日期并赋值
    },
    convertToDate(date) {
