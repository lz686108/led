<template>
  <div style="background-color: #091022; width: 100vw; height: 100vh">
    ...
    <!-- 表头 -->
    <!-- 第二行 -->
    <div style="margin-left: 0.3vw; display: flex; justify-content: flex-start;width:99vw;border:solid 1px red;">
      <!-- 日期控件部分 -->
      <div
        style="
          display: flex;
      ...
      <!-- 热修冷修按钮 -->
      <div style=" display: flex; justify-content: flex-start;width:8vw">
        <div style=" height: 3.3vh;
              width: 4vw;
              border-radius: 0.2vw;
              background-color: #0058ce;
              color: white;
              line-height: 3.5vh;
              text-align: center; ;">热修</div>
        <div>冷修</div>
      </div>
    </div>
    <!-- 第二行 -->
