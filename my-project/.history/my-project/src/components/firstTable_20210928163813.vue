<template>
  <div style="background-color: #091022; width: 100vw; height: 100vh">
    ...
    >
      ...
      >
        <div>
          <img src="../assets/e.png" style="height: 2vh; margin-top: 1.9vh" @click="turnSecound()" />
        </div>
        <div>
          <div
            style="
    ...
    >
      <!-- 表头部分 -->
      <table class="table" style="width: 98vw; border-collapse: collapse;font-size:0.5vw">
        <thead style="color: #f8faff; margin-top: 1vh; width: 98vw;height:9vh">
          <tr>
            <th rowspan="2">序号</th>
            <th rowspan="2">日期</th>
            <th rowspan="2">班次</th>
        ...
        <tbody style="color: #bde5f7; width: 98vw;height:73.5vh;margin-left:0.15vw">
