...
export default {
  ...
  methods: {
    ...
    prevDate() {
      ...
      if (a2 - a1 <= 24 * 60 * 60 * 1000) {
        row[0] = this.convertToDate(
          new Date(this.value1[0]).getTime() - 24 * 60 * 60 * 1000
        ); //格式化日期并赋值
        row[1] = this.convertToDate(
          new Date(this.value1[1]).getTime() - 24 * 60 * 60 * 1000
        ); //格式化日期并赋值
        this.value1 = row;
      }
    },
