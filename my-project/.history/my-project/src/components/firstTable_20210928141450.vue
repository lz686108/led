<template>
  <div style="background-color: #091022; width: 100vw; height: 100vh">
    ...
    >
      <!-- 表头部分 -->
      <table class="table" style="width: 98vw; border-collapse: collapse;font-size:0.7vw">
        <thead style="color: #f8faff; margin-top: 1vh; width: 98vw;height:10vh">
          <tr>
            <th rowspan="2">序号</th>
            <th rowspan="2">日期</th>
            <th rowspan="2">班次</th>
        ...
        <tbody style="color: #bde5f7; width: 98vw;height:72vh;margin-left:0.15vw">
